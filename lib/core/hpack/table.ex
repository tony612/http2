defmodule HTTP2.HPACK.Table do
  @moduledoc false
  ...
  def new(max_table_size, index \\ :store) do
    %__MODULE__{max_table_size: max_table_size, index: index}
  end
  ...
  """
  @spec lookup_by_header(t(), binary(), binary() | nil) :: {:full, pos_integer()} | {:name, pos_integer()} | :not_found
